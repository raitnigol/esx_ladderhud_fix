...
RegisterNetEvent('esx_status:load') -- we need to edit the load event
AddEventHandler('esx_status:load', function(status)
	...
	Citizen.CreateThread(function()
		while true do
			...
			TriggerEvent('esx_ladderhud:updateBasics', GetStatusData(true)) -- don't overwrite onTick event, add this line of code.
